...
java -jar /Developer/Examples/Java/JFC/Java2D/Java2D.jar -javaagent:$JTRACERT_HOME/jTracert.jar=7007 -DclassNameRegEx=.* -DverboseInstrumentation -DverboseAnalyze
APPPID=$!
